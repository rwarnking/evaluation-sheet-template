...
\newcommand{\createtask}[5]{
    \textbf{#1} #2 & \textbf{#3} \cellsA{#4}{#5} \\ \hline
}
\newcommand{\createsubtask}[4]{\small #1 & #2 \cellsA{#3}{#4} \\ \hline}
...
% TODO groups -> dropped out column
% TODO Enable / Disable different display rows
% TODO cant deal with empty columns for the points
% TODO disable showing points
...
\DTLloaddb{points}{\semester"_"\coursename/sheet_01_points.csv}
\DTLloaddb{assignments}{\semester"_"\coursename/sheet_01.csv}
