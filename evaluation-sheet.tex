...
\usepackage{datatool}
\DTLsetseparator{;}
\DTLloaddb{players}{example-coursename-1_201819/persons.csv}
...
\newcommand{\printheader}[1]{%
    ...
    % Add names
    \xintForthree ##1##2##3 in \persondata \do
    {%
        ...
        {%
            ...
            {%
                &%
                % \xDTLassignfirstmatch{players}{\personid}{##1}{\name=\firstname,\points=\lastname}
                % \name \points,\newline%
                % a b
                \DTLfetch{players}{\personid}{##1}{\firstname}
                \DTLfetch{players}{\personid}{##1}{\lastname},\newline%
                \DTLfetch{players}{\personid}{##2}{\firstname}
                \DTLfetch{players}{\personid}{##2}{\lastname}%
            }%
        }%
        %#1 \arabic{iterA}
        %\ifnum #1>\value{iterA}%
    ...
    {%
        ...
        {%
            \xintifCmp{\value{iterA}}{#1-5}{}{}%
            {%
            %\DTLfetch{players}{\personid}{##1}{semester}
                % TODO does not work if the studyfield is empty
                & \DTLfetch{players}{\personid}{##1}{\studyfield}\newline%
                \DTLfetch{players}{\personid}{##2}{\studyfield}
                % & a \newline b
                %\DTLfetch{players}{\personid}{##2}{semester}
                % ##3%
            }%
        }%
        \addtocounter{iterA}{1}%
...
\begin{document}
    ...
    % \DTLforeach*{players} % database label
    % {\firstname=firstname,\lastname=lastname} % assignment
    % {
    %     \firstname{} \lastname\\
    % }
