...
\newcommand{\showidentifier}{\enable}
...
% TODO igrnore entries in groups.csv were no members are present
% TODO add row for tutor group id
% TODO add row for total group id
...
\newcommand{\printheader}[1]{%
    ...
    {%
        ...
        \printheaderrow{#1}{\printcurnames}
    }{}
    ...
    {%
        ...
        \printheaderrow{#1}{\printcurstudy}
    }{}

    \ifthenelse{\equal{\showidentifier}{\enable}}
    {%
        \xintifEq{\pdflanguage}{\english}%
        {%
            \textbf{Identifier} &
        ...
        \printheaderrow{#1}{\printcuridentifier}
    }{}
...
\newcommand{\printheaderrow}[2]{%
    ...
    {\participants=participants, \tutorid=tutorid, \date=date} % assignment
    {%
    ...
    % Add missing "and"s
    \forloop{itergroups}{\value{itergroups} + 1}{\value{itergroups} < #1}{
        &
    }
    \\ \hline
}
