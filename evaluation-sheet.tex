...
\newcommand{\sumcells}[1]{%
    ...
    \xintFor* ##1 in {\xintSeq{#1-\columnsMO}{#1}} \do {%
        ...
        % Mark columns of groups that already dropped out
        \xintifCmp{\sheetnumber}{\lastsheet}
        {
            \cellcolor{black!25}
        }{
            \cellcolor{black!25}
        }{
            % Do not print if points should not be shown
...
\newcommand{\sumrow}[1]{%
    \xintifEq{\pdflanguage}{\english}%
    {%
        \textbf{Sum:} & \sumcells{#1} \\%
    } {%
        \textbf{Summe:} & \sumcells{#1} \\%
    }%
}
