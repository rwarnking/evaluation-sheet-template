...
% TODO automate
\newcommand{\columns}{20}
\newcommand{\columnsMO}{19}
\newcommand{\columnsPO}{21}
...
\begin{document}
    ...
    % TODO do not use amount of groups but rather amount of participants
    % to calculate pages
    \forloop{tablenumber}{0}{\value{tablenumber} < \value{max}}{
        ...
        \pgfmathparse{int ((\value{tablenumber})*\columns)}
