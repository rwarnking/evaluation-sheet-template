...
% The data is read from .csv files that need to be present under the in this document specified
% name. Obviously you can adjust these names to your liking.
...
\begin{document}
    ...
    \IfFileExists{\semester_\coursename/additional_info.tex}{
        \input{\semester_\coursename/additional_info.tex}% chktex 2
    }{}
\end{document}
