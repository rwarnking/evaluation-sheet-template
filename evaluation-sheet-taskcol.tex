...
% TODO: if showsubtaskid or showtitle are enabled it is not possible to disable all info cols
% TODO: sort all length (setlength)
% TODO: Add hspace to info columns
% TODO: Fix cellcolor overdrawing lines
% TODO: \showtitle does not work for 123
...
\newcommand{\printnames}[1]{%
    ...
    {%
        ...
        \DTLfetch{participants_db}{\personidKey}{#1}{\lastnameKey}\hspace*{2pt}%
    }%
}
