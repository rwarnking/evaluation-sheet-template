...
\newcommand{\printheader}[1]{%
    ...
    % \forloop{tmpcounter}{2}{\value{tmpcounter} < #1}{
    % }
    %
...
\newcommand{\creategroup}[1]{%
    \printnames & TODO%
    \forloop{tmpcounter}{0}{\value{tmpcounter} < \value{tmpcol}}{
        &
    }\\ \hline
...
\begin{document}
    ...
    \forloop{tablenumber}{0}{\value{tablenumber} < \value{max}}{
        ...
        \begin{tabularx}{\textwidth}{ *{2}{L;}c*{\value{tmpcol}}{|c} }
            ...
            % \forloop{tablenumber}{0}{\value{tablenumber} < \value{tmpcol}}{
            %     hi &
            % }
            % hi
