...
% TODO actually limit header to that size
...
\newcommand{\printheader}{%
    ...
    \printheadercell{\showname}{TODO}{TODO}%
    \printheadercell{\showstudy}{TODO}{TODO}%
    \printheadercell{\showpersonid}{TD}{TD}%
    \printheadercell{\showtutorgroupid}{T}{T}%
    \printheadercell{\showgroupid}{T}{T}%
    \printheadercell{\showdate}{TODO}{TODO}%
    % TODO unterschiede small and big tasks
    % (not sure if possible - rotate box does not allow newlines,
    % and long text would not be usefull anyway - maybe always use curtitle)
    \DTLforeach*{assignments_db} % database label
    {\curtask=\taskidKey, \curtitle=\titleKey,
        \curpoints=\pointsKey, \curdesc=\descriptionKey}
    {%
        \checkfirstampersand%
        \clipstring{\rotatebox[origin=c]{90}{\curtitle}}
    }%
    \checkfirstampersand%
...
\begin{document}
    ...
    {\curtutorid=\tutoridKey, \curparticipants=\participantsKey}
    {
        ...
        {%
            % TODO do not include participants that joined the group later on
            \xintFor ##1 in \curparticipants \do {%
    ...
    %%%%%%%%%%%%%
    % Iterate all tables
    % TODO adjust font size to width of table
